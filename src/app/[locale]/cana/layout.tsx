...
const excludedSubPaths = ['/cana/grow/', '/cana/testimony/', '/cana/prayer/'];

const excludedExactPaths = new Set(['/cana/milestone']);

function CanaAboutLayout({ children }: Readonly<RootProvider>) {
...
export default CanaAboutLayout;
